...
class JumiaFashionScraper:
    def __init__(self):
        self.base_directory = "D:/bureau/grand projet/jumia/fashion/data"
        self.data_directory = self.base_directory
        
        self.base_url = "https://www.jumia.ma"
        self.start_url = "https://www.jumia.ma/fashion-mode/"
        self.headers = {
