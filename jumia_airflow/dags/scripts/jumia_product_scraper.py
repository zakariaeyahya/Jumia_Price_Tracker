...
class JumiaDataExtractor:
    def __init__(self):
        # Définir les chemins en fonction du script
        script_dir = os.path.dirname(os.path.abspath(__file__))
        self.base_directory = os.path.abspath(os.path.join(script_dir, '../..'))
        self.json_directory = os.path.join(self.base_directory, 'jumia_data')
    ...
    def convert_json_to_csv(self):
        ...
        if not os.path.exists(self.categories_file):
            ...
            print("Assurez-vous d'avoir d'abord exécuté jumia_category_scraper.py")
            return None
...
def main():
    print("Initialisation de l'extracteur de données Jumia...")
